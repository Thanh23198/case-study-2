...
<!--    </div>-->
    ...
    <div class="form-group">
        <label for="exampleInputEmail1">Diem Van</label>
        <input type="text" name="diemvan" class="form-control" id="exampleInputEmail1" placeholder="Enter address here">
    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">Diem Anh</label>
        <input type="text" name="diemanh" class="form-control" id="exampleInputEmail1" placeholder="Enter address here">
    </div>
